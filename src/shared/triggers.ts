 ...
 * Agentic OS IMAJU; setting an org key lets their instance address yours.
 *
...
export const CLONE_NODE_BLURB =
  ...
  + 'Agentic OS IMAJU running on your machine. Each teammate runs their own, so an org key '
